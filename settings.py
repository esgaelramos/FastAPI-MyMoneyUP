...
class Settings(BaseSettings):
    ...
    BACKEND_CORS_ORIGINS: List[
        ...
        []
    )  # ["http://localhost:4400"], Lista de URLs la cual podran acceder a la API
    ...
    REQUEST_INTERVAL: int = (
        1  # Intervalo de tiempo por cada maximo de peticiones
    )
    BLOCK_DURATION: int = (
        60  # Tiempo de bloqueo por exceder la cantidad de peticiones
    )
